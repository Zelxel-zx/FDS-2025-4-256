...
def analisis_geografico(gdf):
    metricas_por_estado = gdf.groupby('geometry').agg({
        'views': 'sum',
        'likes': 'sum',
        'dislikes': 'sum'
    })
    return metricas_por_estado
...
print("\nAnálisis geográfico:")
geo_metricas = analisis_geografico(gdf)
print(geo_metricas.head())
...
print("-"*50)
print("✓ Generados mapas de calor:")
print("  - mapa_calor_views.html")
print("  - mapa_calor_likes.html")
print("  - mapa_calor_dislikes.html")
print("  - mapa_calor_engagement_rate.html")
